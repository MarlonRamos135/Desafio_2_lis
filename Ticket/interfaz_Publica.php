    ...
    <div class="row">
        ...
        <div class="col-sm-4 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <h5 style="color: navy" class="card-title"><b><?= $producto->nombre ?></b></h5>
                    <p style="color:#17456b" class="card-text"><?= $producto->desc?></p>
                    <button style="background-color:#17456b" type="button" class="btn" data-bs-toggle="modal" data-bs-target="#modal_<?= $producto->codigo ?>">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 style="color: #17456b;" class="modal-title fs-5" id="exampleModalLabel"><?= $producto->nombre ?></h1>
                    ...
                    <div class="modal-body">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-sm-7">
                                    <h3 style="color: #17456b;"><?= $producto->codigo ?></h3>
                                    <p><?= $producto->desc ?></p>
                                </div>
                                <div class="col-sm-5">
